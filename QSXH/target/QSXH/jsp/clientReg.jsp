            ...
            <div class="main-log">
                ...
                <form id="form" onsubmit="return false;">
                    ...
                    <div class="main-logbox">
                        ...
                        <input placeholder="登录密码" type="text" class="main-user-input" name="password" id="password" onchange="checkPass()">
                    </div>
                    <%--提示信息--%>
                    ...
                    <div class="main-logbox">
                        <i class="main-password"></i>
                        <input placeholder="再次输入密码" type="text" class="main-user-input" id="repassword" onchange="checkRePass()">
                    </div>
                    <%--提示信息--%>
